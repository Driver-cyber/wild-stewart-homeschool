import type { CurriculumWeek } from './curriculum-types'

// Kindergarten Reading & Spelling — 32 week sequence.
// Source of truth: reference/curriculum-inbox/curriculum-data.js (Joelle's design).
// Re-port from reference/ if her source is updated.
